...
export default function Bharath() {
                    ...
                    <Row className="mt-4 w99p">
                        ...
                        <Col md={6} className="d-flex col-md-6 align-items-center justify-content-center mt-4">
                            <Carousel>
                                ...
                                <Carousel.Item interval={2000}>
                                    <img
                                        className="d-block w-100"
                                        src="/images/2. Atom AC Destination Charging/Single Gun/2.png"
                                        alt="Image Two"
                                    />
                                </Carousel.Item>
                                <Carousel.Item interval={2000}>
                                    <img
                                        className="d-block w-100"
                                        src="/images/2. Atom AC Destination Charging/Single Gun/q3.png"
                                        alt="Image Two"
                                    />
                                </Carousel.Item>
                                <Carousel.Item interval={2000}>
                                    <img
                                        className="d-block w-100"
                                        src="/images/5. Atom AC Bharath Charger/1.png"
                                        alt="Image Two"
                                    />
                                </Carousel.Item>
                                <Carousel.Item interval={2000}>
                                    <img
                                        className="d-block w-100"
                                        src="/images/5. Atom AC Bharath Charger/2.png"
                                        alt="Image Two"
                                    />
                                </Carousel.Item>
                            </Carousel>
                        ...
                        <Col md={6}>
                            <div className="d-flex flex-column">
                                ...
                                <span className="p-headings lite-black line-height-0 medium">Bharath Charger</span>
            ...
            <div className="p-2-section-3 p30">
                ...
                <Row className="w99p">
                    ...
                    <Col className="overflow-hidden" md={6}>
                        <img data-aos="fade-left" data-aos-offset="200" data-aos-delay="150" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false"  data-aos-anchor-placement="top-bottom"  src="/images/2. Atom AC Destination Charging/Single Gun/1.png" id="1" className="w99p mb-3" />
                    </Col>
                </Row>
                <Row className="w99p">
                    <Col md={1} sm={12}></Col>
                    <Col className="d-flex justify-content-center order-2 overflow-hidden" md={5}>
                        <img data-aos="fade-left" data-aos-offset="200" data-aos-delay="150" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="false" data-aos-once="false"  data-aos-anchor-placement="top-bottom"   src="/images/2. Atom AC Destination Charging/Single Gun/2.png" className="w99p mb-3" />
                    </Col>
                ...
                <Row className="">
                    ...
                    <Col className="d-flex align-items-center justify-content-center order-2 overflow-hidden" md={5}>
                        <img data-aos="fade-left" data-aos-offset="200" data-aos-delay="150" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false"  data-aos-anchor-placement="top-bottom"   src="/images/5. Atom AC Bharath Charger/2.png" className="w500 mb-3" />
                    </Col>
